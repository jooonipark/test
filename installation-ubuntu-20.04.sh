...
mysql -u root --execute="CREATE USER 'cms4bookstack'@'localhost' IDENTIFIED WITH mysql_native_password BY 'QkdRnEhdRn123!@#';"
mysql -u root --execute="GRANT ALL ON bookstack.* TO 'cms4bookstack'@'localhost';FLUSH PRIVILEGES;"
